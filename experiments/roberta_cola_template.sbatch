...
#SBATCH --error=$RAWIDENTIFIER-%j.err
...
IDENTIFIER="experiment_robertalarge_cola_svd_3407"
...
RECONSTRUCT_TYPE="svd"  # overrides the value from the reconstruct_config
